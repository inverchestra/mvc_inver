...
{
    public class HospMedicalInformation
    {
        ...
        private double primaryContactNumber;
        public double PrimaryContactNumber
        {
        ...
        private double secondaryContactNumber;
        public double SecondaryContactNumber
        {
