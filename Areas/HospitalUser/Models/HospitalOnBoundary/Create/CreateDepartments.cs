...
namespace InnDocs.iHealth.Web.UI.Areas.HospitalUser.Models.HospitalOnBoundary.Create
{
    ...
    {
        public static int CreateDepartment(Departments dep)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(Departments)));
                searialzeToInsert.WriteObject(ms, dep);
                string ServiceURL = DomainServerPath.Service+"HospitalInfo/InsertDepartmentsInfo";
