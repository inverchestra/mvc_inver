...
namespace InnDocs.iHealth.Web.UI.Areas.HospitalUser.Models.HospitalOnBoundary.Create
{
    public class CreateBranch
    {
        ...
        public static int InsertBranhInfo(Branch branch)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(Branch)));
                searialzeToInsert.WriteObject(ms, branch);
                string ServiceURL = DomainServerPath.Service+"HospitalInfo/InsertBranchInfo";
