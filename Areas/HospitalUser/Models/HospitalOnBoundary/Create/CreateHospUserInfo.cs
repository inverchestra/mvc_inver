...
{
    public class CreateHospUserInfo
    {
        public static int InsertHospUserInfo(HospitalUserInfo Huser)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(HospitalUserInfo)));
                searialzeToInsert.WriteObject(ms, Huser);
