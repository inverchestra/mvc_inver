...
{
    public class CreateHospitalPersonalInfo
    {
        public static int InsertHospitalPersonalInfo(CreateHospitalPersonalInfo hp)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(CreateHospitalPersonalInfo)));
                searialzeToInsert.WriteObject(ms, hp);
