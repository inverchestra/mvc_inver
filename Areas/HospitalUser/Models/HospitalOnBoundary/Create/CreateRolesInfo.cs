...
{
    public class CreateRolesInfo
    {
        public static int InsertHospUserInfo(Roles role)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(Roles)));
                searialzeToInsert.WriteObject(ms, role);
