...
namespace InnDocs.iHealth.Web.UI.Areas.HospitalUser.Models.HospitalOnBoundary.Create
{
    ...
    {
        public static int InsertDoctorsInfo(Doctors doc)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(Doctors)));
                searialzeToInsert.WriteObject(ms, doc);
                string ServiceURL = DomainServerPath.Service+"HospitalInfo/InsertDoctorsInfo";
    ...
    {
        public static string InsertUserInfo(CreateUser doc, string type)
        {
            try
            {
                WebClient caseProxy1 = new WebClient();
                ...
                caseProxy1.Headers["Accept"] = "application/json";
                MemoryStream ms = new MemoryStream();
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(CreateUser)));
                searialzeToInsert.WriteObject(ms, doc);
