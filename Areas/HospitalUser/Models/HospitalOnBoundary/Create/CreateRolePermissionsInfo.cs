...
{
    public class CreateRolePermissionsInfo
    {
        public static int InsertHospUserInfo(RolePermissions roleper)
        {
            try
            {
                ...
                DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(RolePermissions)));
                searialzeToInsert.WriteObject(ms, roleper);
