...
namespace InnDocs.iHealth.Web.UI.Areas.iHealthUser.Models.UserServiceRepository
{
    ...
    {
        public static string InsertProcedureInfo(Procedure pr)
        {
            ...
            DataContractJsonSerializer searialzeToInsert = new DataContractJsonSerializer((typeof(Procedure)));
            searialzeToInsert.WriteObject(ms, pr);
            string ServiceURL = DomainServerPath.Service+"CaseManagement/InsertProcedure";
